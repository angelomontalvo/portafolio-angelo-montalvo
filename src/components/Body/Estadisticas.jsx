  ...
  const featuresData = [
    {
      icon: (
        <svg
          ...
          class="text-purple-500 size-8 mt-4"
        >
  ...
  return (
    <>
      <div class="text-center">
        <p class="text-center font-medium text-purple-400 px-10 py-1.5 rounded-full bg-purple-950 border border-purple-800 w-max mx-auto">
          Features
        </p>
        <h2 class="text-3xl font-semibold text-center mx-auto mt-4 text-white">
          Built for builders
        </h2>
      ...
      <div class="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-10 px-6">
        {featuresData.map((feature, index) => (
          <div
            key={index}
            className={`hover:-translate-y-0.5 transition duration-300 ${index === 1 ? "p-px rounded-[13px] bg-gradient-to-br from-[#9544FF] to-[#223B60]" : ""}`}
          >
